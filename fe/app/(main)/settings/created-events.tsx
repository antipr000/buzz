...
export default function CreatedEventsScreen() {
  ...
  const listHeader = (
    ...
    >
      ...
      <Text className="text-xl font-semibold text-[#F97316]">Created events</Text>
    </View>
  )
      ...
      <View className="flex-1 bg-surface">
        ...
        <View className="flex-1 items-center justify-center px-10">
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text className="text-[#FF8A00] text-sm font-medium">Back to settings</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
