...
Revision ID: c17caa7fd167
Revises: a1b2c3d4e5f6
Create Date: 2026-03-25 16:20:26.527969
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('HOME', 'WORK', 'OTHER', name='addresstype', native_enum=False, length=32), nullable=False),
    ...
    sa.Column('identify', sa.Enum('MAN', 'WOMAN', 'OTHER', name='profileidentify', native_enum=False, length=32), nullable=True),
    sa.Column('marital_status', sa.Enum('SINGLE', 'MARRIED', name='maritalstatus', native_enum=False, length=32), nullable=True),
    ...
    sa.Column('category', sa.Enum('MUSIC', 'NIGHTLIFE', 'TECH', 'STARTUP', 'GAMING', 'FOOD', 'SOCIAL', 'WELLNESS', 'FITNESS', 'FAMILY', 'KIDS', 'ART', 'CULTURE', name='eventcategory', native_enum=False, length=32), nullable=False),
    ...
    sa.Column('status', sa.Enum('UPCOMING', 'ATTENDED', 'CANCELLED', name='bookingstatus', native_enum=False, length=32), nullable=False),
    sa.Column('id', sa.String(length=255), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('payment_method', sa.Enum('UPI', 'CREDIT_DEBIT_CARD', 'PAY_LATER', 'WALLETS', 'EMI', 'NET_BANKING', 'CASH_ON_DELIVERY', name='paymentmethod', native_enum=False, length=32), nullable=False),
    sa.Column('amount', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PENDING_PAYMENT', 'COMPLETED', 'FAILED', name='paymentstatus', native_enum=False, length=32), nullable=False),
    sa.Column('id', sa.String(length=255), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('booking_id', sa.String(length=255), nullable=False),
    sa.Column('ticket_tier', sa.Enum('STANDARD', 'PREMIUM', 'VIP', name='tickettier', native_enum=False, length=32), nullable=False),
    sa.Column('price', sa.Integer(), nullable=False),
